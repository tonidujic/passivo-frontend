...
}[Keys] & StrictOmit<Type, Keys>;
export type RequireAtLeastOne<Type extends AnyRecord, Keys extends keyof Type = keyof Type> = IsAny<Type> extends true ? any : _RequireAtLeastOne<Type, Keys>;
export {};
